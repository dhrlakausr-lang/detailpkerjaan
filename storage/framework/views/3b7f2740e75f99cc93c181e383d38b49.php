                ...
                <table role="presentation" width="460" cellpadding="0" cellspacing="0" style="max-width:460px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 20px;font-size:14px;color:#4b5563;line-height:1.6;">
                                Anda meminta reset password untuk akun <strong><?php echo e($email); ?></strong>.
                    ...
                    <tr>
                        <td style="padding:20px 32px;background-color:#f9fafb;border-top:1px solid #eef0f2;">
                            <p style="margin:0;font-size:12px;color:#9ca3af;">&copy; <?php echo e(date('Y')); ?> LokerinAja. Email otomatis, mohon tidak dibalas.</p>
                        </td>
                    </tr>
                </table>
            </td>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/detail.pkerjaan.dara/resources/views/emails/otp.blade.php ENDPATH**/ ?>